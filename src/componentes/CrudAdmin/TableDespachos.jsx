...
export const TableDespachos = () => {
  ...
  // Llamada a la funci�n para obtener los datos cuando el componente se monta
  useEffect(() => {
    despacho();
  }, []);
            ...
            <table className="table-fixed">
              <thead>
                <tr className="py-10">
                  ...
                  <th className="pr-10">Direcci�n de entrega</th>
                  <th className="pr-10">Fecha despacho</th>
                  <th className="pr-10">Patente Cami�n</th>
