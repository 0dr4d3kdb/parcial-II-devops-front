  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "El despacho ha sido generado con �xito en la base de datos",
        icon: "success",
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mb-5">
          <label className="block font-bold mb-2">Patente de cami�n</label>
          <input
            type="text"
            placeholder="Elige patente de cami�n"
            className="border border-gray-300 rounded-lg block w-full p-1"
        ...
        <div className="mb-5">
          <label className="block font-bold mb-2">Direcci�n de entrega</label>
          <input
            type="text"
            disabled={true}
